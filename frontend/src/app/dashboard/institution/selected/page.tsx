                      ...
                      <div className="flex gap-3 p-3.5 bg-amber-50 border border-amber-200 rounded-xl">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-[10px] font-black text-amber-700 uppercase tracking-widest mb-1">
                            {t('Task from Tensai', 'Tensaiからのタスク', 'Tensai-এর নির্দেশনা')}
                            {app.admin_note_at && (
                              <span className="ml-2 font-normal normal-case text-amber-500">
                                — {new Date(app.admin_note_at).toLocaleDateString(undefined, { dateStyle: 'medium' })}
                              </span>
                            )}
                          </p>
                          <p className="text-xs text-amber-900 leading-relaxed whitespace-pre-wrap">{app.admin_note}</p>
                        </div>
                      </div>
                    )}
