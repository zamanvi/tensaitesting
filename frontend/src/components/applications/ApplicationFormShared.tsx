...
export function colSpan(size: TemplateField['box_size']) {
  // grid: cols-1 / sm:cols-2 / md:cols-4 / lg:cols-6
  if (size === 'small') return 'col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-2';
  if (size === 'full')  return 'col-span-1 sm:col-span-2 md:col-span-4 lg:col-span-6';
  return 'col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-3';
}