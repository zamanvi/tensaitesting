...
<head>
  ...
  <style>
    ...
    .wrapper { max-width: 560px; margin: 16px auto 40px; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.07); }
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p class="text">
        This memo confirms we have received your payment directly on behalf of Tensai —
