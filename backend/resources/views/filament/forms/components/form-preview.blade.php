        ...
        <div style="padding:18px 22px 16px;background:#fff;">
            <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                <div>
                    ...
                    <h2 style="font-size:20px;font-weight:800;color:#111827;line-height:1.2;margin-bottom:0;">{{ $record->name ?: 'Application Form' }}</h2>
                    <div style="height:2px;background:#16a34a;width:100%;margin:6px 0 6px;"></div>
