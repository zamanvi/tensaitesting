...
class FormTemplateResource extends Resource
{
    ...
    protected static ?string $navigationLabel  = 'Service Forms';
    protected static ?string $modelLabel       = 'Service Form';
    protected static ?string $pluralModelLabel = 'Service Forms';
